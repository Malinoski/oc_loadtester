...
public class OcLoadtesterAnalyser3 {
	...
	public static void old(String ars[]) {
		...
		String bruteDataFile = ""; // java result file path (csv)
		String processedDataFile = ""; // java result file path (csv)
		if(ars.length != 0) {
			gatlingResultPath = ars[0];
			bruteDataFile = ars[1];
			processedDataFile = ars[2];
		}else {
			gatlingResultPath = "/Users/iuri/gatling-results/gatling-results_v7";
			bruteDataFile = "WebContent/gatling-results-v7-brute.csv";
			processedDataFile = "WebContent/gatling-results-v7-processed.csv";
		}
